...
import util.CommonConstants.{CLEANED_PLUTO_PATH, CLEANED_SUBWAY_PATH, CLEANED_EDUCATION_PATH}
...
object Processor {
  ...
  def preprocess(sc: SparkContext, hdfs: FileSystem, path: String): Unit = {
    ...
    */
    ...
    val educationRDD = EducationProcess.processEducation(sc, hdfs, cleanedEducationPath, plutoData)
