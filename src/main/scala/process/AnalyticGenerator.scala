...
object AnalyticGenerator {
  ...
  def generateAnalytic(sess: SparkSession, sc: SparkContext, hdfs: FileSystem, path: String, cleanedPlutoPath: String, subwayRDD: RDD[(String, (Double, (String, String)))], crimeRDD: RDD[(String, (Double, (String, String)))], educationRDD: RDD[(String, (Double, (String, String)))], propertyRDD: RDD[(String, Double)]) = {
    var now = System.currentTimeMillis()
    val BBAnalyticRDD = boroughBlockAnalytic(sess, sc, hdfs, path, subwayRDD, crimeRDD, educationRDD, propertyRDD)
  ...
  private def boroughBlockAnalytic(sess: SparkSession, sc: SparkContext, hdfs: FileSystem, path: String, subwayRDD: RDD[(String, (Double, (String, String)))], crimeRDD: RDD[(String, (Double, (String, String)))], educationRDD: RDD[(String, (Double, (String, String)))], propertyRDD: RDD[(String, Double)]) = {
