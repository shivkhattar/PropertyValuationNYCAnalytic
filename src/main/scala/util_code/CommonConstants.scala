...
//  Object that contains all the constants being used in the application codebase
object CommonConstants {
  ...
  final val CRIME_YEAR_FROM = 2019
  ...
  final val CRIME_LEVEL_FELONY = "FELONY"
  ...
  final val PROP_ISRESIDENTIAL = "RESIDENTIAL"

  final val PROP_RESIDENTIAL_AREA = "RESIDENTIAL_AREA"

  final val PROP_CONSTRUCTED_AREA = "CONSTRUCTED_AREA"
  ...
  final val ED_FISCAL_YEAR = "FISCAL_YEAR"

  final val ADDR_SUBSTRING_PARAM = "NY 1"
  ...
  final val PROP_FILTER_YEAR = "2020"

  final val PROP_ZERO = "0"
  ...
  final val PROCESS_TOTAL = "total"

  final val PROCESS_MAX_MIN = "max_min"
}